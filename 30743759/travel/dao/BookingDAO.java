...
public class BookingDAO {
    public void createBooking(Booking booking) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setDate(3, new Date(booking.getBookingDate().getTime()));
            stmt.setDate(4, new Date(booking.getStartDate().getTime()));
            stmt.setDate(5, new Date(booking.getEndDate().getTime()));

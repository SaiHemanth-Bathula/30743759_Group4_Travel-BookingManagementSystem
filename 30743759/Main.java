...
public class Main {
    ...
    private static DestinationDAO destinationDAO = new DestinationDAO();
    ...
    private static void updateBooking() {
        ...
        if (booking != null) {
            ...
            if (!startDateStr.isEmpty()) booking.setStartDate(java.sql.Date.valueOf(startDateStr));
            if (!endDateStr.isEmpty()) booking.setEndDate(java.sql.Date.valueOf(endDateStr));
